...
const direct = 'D:/OOP_project/landmark-recognition-2020';
...
set_candle = ()=>
{
    var c_temp = [];
    var c_result = [];
    const data = fs.createReadStream("D:/OOP_project/OOP_Project_2/XAGUSD60.csv").pipe(csv()).on('data', (data) => c_temp.push(data))
    .on('end', () => {
